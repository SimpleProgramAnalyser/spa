...
TEST_CASE("Modifies relationships stored correctly for test program - getModifiesStatements")
{
...
TEST_CASE("Modifies relationships stored correctly for test program - getModifiesProcedures")
{
    // Variable name - depth
...
TEST_CASE("Modifies relationships stored correctly for test program - getModifiesVariablesFromStatement")
{
    ...
    std::unordered_set<String> actualModifiesVariablesFromStatement7Set(actualModifiesVariablesFromStatement7.begin(),
                                                                        actualModifiesVariablesFromStatement7.end());
    ...
    std::unordered_set<String> actualModifiesVariablesFromStatement24Set(actualModifiesVariablesFromStatement24.begin(),
                                                                         actualModifiesVariablesFromStatement24.end());
...
TEST_CASE("Modifies relationships stored correctly for test program - getModifiesVariablesFromProcedure")
{
    // Procedure name - main
    ...
    std::vector<String> actualAllModifiesVariablesFromProcedureRaymarch = getModifiesVariablesFromProcedure("raymarch");
    std::unordered_set<String> actualAllModifiesVariablesFromProcedureRaymarchSet(
        actualAllModifiesVariablesFromProcedureRaymarch.begin(), actualAllModifiesVariablesFromProcedureRaymarch.end());
    std::unordered_set<String> expectedAllModifiesVariablesFromProcedureRaymarchSet
        = {"ro", "rd", "depth", "po", "done", "count", "dist", "x", "p"};
    REQUIRE(actualAllModifiesVariablesFromProcedureRaymarchSet == expectedAllModifiesVariablesFromProcedureRaymarchSet);
...
TEST_CASE("Modifies relationships stored correctly for test program - getAllModifiesStatements")
{
...
TEST_CASE("Modifies relationships stored correctly for test program - getAllModifiesVariables by statement type")
{
    // StmtType - AnyStatement type
    std::vector<String> actualAllModifiesVariablesByStatementType = getAllModifiesVariables(AnyStatement);
    ...
    // StmtType - CallStatement type
    std::vector<String> actualAllModifiesVariablesByCallStatementType = getAllModifiesVariables(CallStatement);
    ...
    // StmtType - AssignmentStatement type
    std::vector<String> actualAllModifiesVariablesByAssignStatementType = getAllModifiesVariables(AssignmentStatement);
    std::unordered_set<String> actualAllModifiesVariablesByAssignStatementTypeSet(
        actualAllModifiesVariablesByAssignStatementType.begin(), actualAllModifiesVariablesByAssignStatementType.end());
    std::unordered_set<String> expectedAllModifiesVariablesByAssignStatementTypeSet
        = {"ro", "rd", "depth", "po", "done", "count", "dist", "x", "p"};
    REQUIRE(actualAllModifiesVariablesByAssignStatementTypeSet == expectedAllModifiesVariablesByAssignStatementTypeSet);

    // StmtType - WhileStatement type
    std::vector<String> actualAllModifiesVariablesByWhileStatementType = getAllModifiesVariables(WhileStatement);
    std::unordered_set<String> actualAllModifiesVariablesByWhileStatementTypeSet(
        actualAllModifiesVariablesByWhileStatementType.begin(), actualAllModifiesVariablesByWhileStatementType.end());
    std::unordered_set<String> expectedAllModifiesVariablesByWhileStatementTypeSet
        = {"po", "dist", "x", "depth", "p", "done", "count"};
    REQUIRE(actualAllModifiesVariablesByWhileStatementTypeSet == expectedAllModifiesVariablesByWhileStatementTypeSet);

    // StmtType - IfStatement type
    std::vector<String> actualAllModifiesVariablesByIfStatementType = getAllModifiesVariables(IfStatement);
    ...
    std::vector<String> actualAllModifiesVariablesByReadStatementType = getAllModifiesVariables(ReadStatement);
    ...
    std::vector<String> actualAllModifiesVariablesByPrintStatementType = getAllModifiesVariables(PrintStatement);
    std::unordered_set<String> actualAllModifiesVariablesByPrintStatementTypeSet(
        actualAllModifiesVariablesByPrintStatementType.begin(), actualAllModifiesVariablesByPrintStatementType.end());
    std::unordered_set<String> expectedAllModifiesVariablesByPrintStatementTypeSet = {};
    REQUIRE(actualAllModifiesVariablesByPrintStatementTypeSet == expectedAllModifiesVariablesByPrintStatementTypeSet);
}

/*
TEST_CASE("Modifies relationships stored correctly for test program - getAllModifiesVariablesFromProcedure")
{
    std::vector<String> actualAllModifiesVariablesByProcedureMain = getAllModifiesVariables("main");
