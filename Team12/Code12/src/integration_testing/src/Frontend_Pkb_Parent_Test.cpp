...
TEST_CASE("Parent relationships stored correctly for test program - getAllParentStatementsTyped")
{
    ...
    std::unordered_set<Integer> actualParentWhileCallSet(actualParentWhileCall.begin(), actualParentWhileCall.end());
    std::unordered_set<Integer> expectedParentWhileCallSet = {7};
    REQUIRE(actualParentWhileCallSet == expectedParentWhileCallSet);
}

TEST_CASE("Parent relationships stored correctly for test program - getAllChildStatementsTyped")
{
    // Parent - AnyStatement type, Child - AnyStatement type
    ...
    std::unordered_set<Integer> actualChildWhileAssignSet(actualChildWhileAssign.begin(), actualChildWhileAssign.end());
...
TEST_CASE("Parent* relationships stored correctly for test program - getAllParentStatementsTypedStar")
{
...
TEST_CASE("Parent* relationships stored correctly for test program - getAllChildStatementsTypedStar")
{
    // Parent - AnyStatement type, Child - PrintStatement type
    ...
    // Parent - WhileStatement type, Child - AssignmentStatement type
    std::vector<Integer> actualChildWhileAssign = getAllChildStatementsTypedStar(WhileStatement, AssignmentStatement);
    std::unordered_set<Integer> actualChildWhileAssignSet(actualChildWhileAssign.begin(), actualChildWhileAssign.end());
...
TEST_CASE("Parent* relationships stored correctly for test program - getAllChildStatementsStar")
{
...
TEST_CASE("Parent* relationships stored correctly for test program - getAllParentStatementsStar")
{
