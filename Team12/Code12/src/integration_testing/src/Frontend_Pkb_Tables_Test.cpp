...
TEST_CASE("Procedure Table stored program correctly for test program")
{
...
TEST_CASE("Variable Table stored variables in program correctly for test program")
{
...
TEST_CASE("Statement Table stored statements in program correctly for test program")
{
    ...
    std::unordered_set<Integer> actualPrintStatementsSet(actualPrintStatements.begin(), actualPrintStatements.end());
    ...
    std::unordered_set<Integer> actualWhileStatementsSet(actualWhileStatements.begin(), actualWhileStatements.end());
    ...
    std::unordered_set<Integer> actualAssignStatementsSet(actualAssignStatements.begin(), actualAssignStatements.end());
...
TEST_CASE("Constant Table stored constants in program correctly for test program")
{
    // Check for constants
...
TEST_CASE("RootNode of program is stored correctly for test program")
{
