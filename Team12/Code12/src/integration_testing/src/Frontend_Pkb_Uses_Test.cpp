...
TEST_CASE("Uses relationships stored correctly for test program - getUsesesStatements")
{
...
TEST_CASE("Uses relationships stored correctly for test program - getUsesProcedures")
{
    // Variable name - depth
...
TEST_CASE("Uses relationships stored correctly for test program - getUsesVariablesFromStatement")
{
...
TEST_CASE("Uses relationships stored correctly for test program - getUsesVariablesFromProcedure")
{
    // Procedure name - main
...
TEST_CASE("Uses relationships stored correctly for test program - getAllUsesStatements")
{
...
TEST_CASE("Uses relationships stored correctly for test program - getAllUsesVariables by statement type")
{
    // StmtType - AnyStatement type
    std::vector<String> actualAllUsesVariablesByStatementType = getAllUsesVariables(AnyStatement);
    std::unordered_set<String> actualAllUsesVariablesByStatementTypeSet(actualAllUsesVariablesByStatementType.begin(),
                                                                        actualAllUsesVariablesByStatementType.end());
    ...
    // StmtType - CallStatement type
    std::vector<String> actualAllUsesVariablesByCallStatementType = getAllUsesVariables(CallStatement);
    ...
    // StmtType - AssignmentStatement type
    std::vector<String> actualAllUsesVariablesByAssignStatementType = getAllUsesVariables(AssignmentStatement);
    ...
    std::vector<String> actualAllUsesVariablesByWhileStatementType = getAllUsesVariables(WhileStatement);
    ...
    std::vector<String> actualAllUsesVariablesByIfStatementType = getAllUsesVariables(IfStatement);
    ...
    std::vector<String> actualAllUsesVariablesByReadStatementType = getAllUsesVariables(ReadStatement);
    ...
    std::vector<String> actualAllUsesVariablesByPrintStatementType = getAllUsesVariables(PrintStatement);
...
/*
TEST_CASE("Uses relationships stored correctly for test program - getAllUsesVariablesFromProcedure")
{
    std::vector<String> actualAllUsesVariablesByProcedureMain = getAllUsesVariables("main");
    std::unordered_set<String> actualAllUsesVariablesByProcedureMainSet(actualAllUsesVariablesByProcedureMain.begin(),
                                                                        actualAllUsesVariablesByProcedureMain.end());
